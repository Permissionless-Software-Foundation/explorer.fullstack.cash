...
<h3>A 'block explorer' for the <a href="https://github.com/Permissionless-Software-Foundation/ipfs-bch-wallet-service" target="_blank">pay-to-write database (P2WDB)</a></h3>
